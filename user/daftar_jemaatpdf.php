 			...
 			<table align="center" border="1" cellpadding="6">
 				<thead>
                  ...
                  <tbody>
                    ...
                    $total_pengeluaran=0;
                    if($kolom == "semua"){
                      $data = mysqli_query($koneksi,"SELECT * FROM jemaat ORDER BY kolom DESC ");
                    }else{
                    ...
                    while($d = mysqli_fetch_array($data)){
                      ...
                      <tr>
                        ...
                        <td align="center"><?php echo strtoupper ($d['jekel']); ?></td>
                        <td align="center"><?php echo  $d['kolom']; ?></td>
...
<?php 
  ...
  $dompdf->render();
  $dompdf->stream("Daftar Jemaat Musoma.pdf");  
  ?>
