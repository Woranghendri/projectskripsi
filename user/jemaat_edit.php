            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  $no=1;
                  $id_user = $_SESSION['id'];
                  $data = mysqli_query($koneksi,"SELECT * FROM jemaat where user_id='$id_user'");
              ...
              <?php
              if($d['edit_jemaat'] == "selesai"){
                ?>
              
                          <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit_jemaat_<?php echo $d['id_jemaat'] ?>">
                          <i class="fa fa-edit"></i>
                        </button>
                  <?php
                }
                ?>
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#izin_edit_<?php echo $d['id_jemaat'] ?>">
                          <i class="fa fa-gear"></i>
                        </button>
                  

                          <!-- modal izin edit  -->
                        <form action="jemaat_izin.php" method="post" enctype="multipart/form-data">
                          <div class="modal fade" id="izin_edit_<?php echo $d['id_jemaat'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title" id="exampleModalLabel">Izin Mengedit Data</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">              
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    <label>Alasan mengedit data</label>
                                    <input type="hidden" name="id" value="<?php echo $d['id_jemaat'] ?>">
                                    <textarea name="alasan_edit" style="width:100%" class="form-control" rows="4"></textarea>
                                  </div>

                                  <div class="form-group">
                                    <label>Upload Kartu Keluarga Untuk Izin Edit</label><br>
                                    <input type="file" name="foto_izin" required="required" class="form-control">
                                    <font color="red">*File yang di perbolehkan *PDF | *JPG | *jpeg</font>
