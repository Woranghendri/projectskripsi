    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-black">
          <div class="inner">
            <?php 
            $t_pemasukan = mysqli_query($koneksi,"SELECT sum(transaksi_nominal) as total_pemasukan FROM transaksi WHERE transaksi_jenis='Pemasukan'");
            $t_pengeluaran = mysqli_query($koneksi,"SELECT sum(transaksi_nominal) as total_pengeluaran FROM transaksi WHERE transaksi_jenis='pengeluaran'");

            $tmasuk = mysqli_fetch_assoc($t_pemasukan);
            $tkeluar = mysqli_fetch_assoc($t_pengeluaran);
            ?>
            <h4 style="font-weight: bolder"><?php echo "Rp. ".number_format($tmasuk['total_pemasukan']-$tkeluar['total_pengeluaran'])." ,-" ?></h4>
            <p>Total Saldo</p>
          </div>
          <div class="icon">
            <i class="ion ion-stats-bars"></i>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $sql = mysqli_query($koneksi,"SELECT * FROM jemaat ");
            $cek = mysqli_num_rows ($sql)
            ?>
            <h4 >Jumlah Anggota Jemaat</h4>
            <h4 style="font-weight: bolder"><?php echo $cek ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $sql = mysqli_query($koneksi,"SELECT (baptis)  FROM jemaat WHERE baptis='Sudah' ");
            $cek = mysqli_num_rows ($sql)
            ?>
            <h4 >Jumlah Baptis</h4>
            <h4 style="font-weight: bolder"><?php echo $cek ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $sql = mysqli_query($koneksi,"SELECT (sidi)  FROM jemaat WHERE sidi='Sudah' ");
            $cek = mysqli_num_rows ($sql)
            ?>
            <h4 >Jumlah Sidi Jemaat</h4>
            <h4 style="font-weight: bolder"><?php echo $cek ?></h4>
