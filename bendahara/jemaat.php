        ...
        <label class="col-sm-3 col-form-label">Relasi Keluarga</label><br/>
          <select name="relasi" id="relasi" class="form-control">
            ...
            <option>ANAK</option>
                      ...
                      <div class="form-group">
                        <label>KOLOM</label>
                        <input type="text" name="kolom" required="required" class="form-control" placeholder="Kolom ..">
                      </div>
        ...
        <label class="col-sm-4 col-form-label">Status Pernikahan</label> <font color="red">*Tidak harus mengisi tanggal jika belum menikah</font><br/>
          <select name="status_nikah" id="status_nikah" class="form-control">
            ...
            <option>CERAI HIDUP</option> 
                      ...
                      <div class="form-group">
                        <label>TELEPON</label>
                        <input type="text" name="telepon" required="required" class="form-control" placeholder="Telepon ..">
                      </div>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="form-group" style="width:100%;margin-bottom:20px">
                                  ...
                                  <input type="text" style="width:100%" name="nik" required="required" class="form-control" placeholder="Nik.." value="<?php echo $d['nik'] ?>">
                                </div>
                                ...
                                <div class="form-group" style="width:100%;margin-bottom:20px">
                                  <label>JUMLAH ANGGOTA KELUARGA</label>
                                  <input type="text" style="width:100%" name="jumlah_anggota" required="required" class="form-control" placeholder="Jumlah Anggota Keluarga .." value="<?php echo $d['jumlah_anggota'] ?>">
                                </div>
