              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="level" required="required">
                    ...
                    <option <?php if($d['user_level'] == "bendahara"){echo "selected='selected'";} ?> value="bendahara"> Bendahara </option>
                    <option <?php if($d['user_level'] == "user"){echo "selected='selected'";} ?> value="user"> User </option>
                  </select>
                </div>
