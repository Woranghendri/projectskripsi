...
<head>
  ...
  if($_SESSION['status'] != "administrator_logedin"){
    header("location:../index2 .php?alert=belum_login");
  }
  ?>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              ...
              <?php 
            $sql = mysqli_query($koneksi,"SELECT (edit_jemaat)  FROM jemaat WHERE edit_jemaat='proses' ");
            ...
            if($cek > 0){
            ?> 
            <span  class="badge rounded-pill badge-notification bg-red"><?php echo "✴" ?>
          <?php
           }
          ?>
            </span>
            ...
            <ul class="treeview-menu" style="display: none;">
              ...
              <li><a href="jemaat_izinedit.php"><i class="fa fa-circle-o"></i>Laporan Edit Data Jemaat 
                <?php 
            if($cek > 0){
            ?> 
              <span class="badge rounded-pill badge-notification bg-red"><?php echo $cek ?> <?php
           }
          ?> </span></a></li>
          <li><a href="daftar_jemaat.php"><i class="fa fa-circle-o"></i>Cetak Daftar Jemaat</a></li>
            </ul>
          </li>
